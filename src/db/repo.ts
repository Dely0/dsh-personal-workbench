...
// ---------------------------------------------------------------------------
// reminder queue（微信提醒待发队列，见 docs/design/2026-09-09-reminder-channel-adapter.md §6）
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// 知识库域已抽到 repo/knowledge.ts（实现见该文件；此处再导出保持对外 API 不变）
export {
